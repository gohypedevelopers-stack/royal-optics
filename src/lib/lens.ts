...
export const EYEGLASS_PRESCRIPTION_OPTIONS: Record<string, LensOption[]> = {
  single_vision: [
    ...
    { key: "psv_blublock_advance", label: "Blu-Block Mild Hi-Index 1.60", description: "20% thinner than basic" },
    { key: "psv_blublock_premium", label: "Blu-Block Medium Hi-Index 1.67", description: "28% thinner than basic lens" },
    { key: "psv_blublock_exclusive", label: "Blu-Block Hi-Index 1.74", description: "40% thinner than basic lens" },
    ...
    { key: "psv_tinted_uv", label: "Tinted UV-Lenses (Select the Color)", requiresTint: true },
    { key: "psv_polarized_basic", label: "Polarized Lenses - Basic" },
    { key: "psv_polarized_advance", label: "Polarized Lenses - Advance" },
    { key: "psv_night_drive_yellow", label: "Night Drive Yellow Colour" },
    { key: "psv_day_night_basic", label: "Day & Night Lenses Basic" },
    { key: "psv_day_night_turbo", label: "Day & Night Lenses Turbo" },
  ],
  reader: [
    ...
    { key: "reader_blublock_advance", label: "Blu-Block Mild Hi-Index 1.60", description: "20% thinner than basic" },
    { key: "reader_blublock_premium", label: "Blu-Block Medium Hi-Index 1.67", description: "28% thinner than basic lens" },
    { key: "reader_blublock_exclusive", label: "Blu-Block Hi-Index 1.74", description: "40% thinner than basic lens" },
  ],
  bifocal: [
    ...
    { key: "pbf_blublock_advance", label: "Blu-Block Mild Hi-Index 1.60", description: "20% thinner than basic" },
    { key: "pbf_tinted_uv", label: "Tinted UV-Lenses (Select the Color)", requiresTint: true },
    { key: "pbf_polarized_basic", label: "Polarized Lenses - Basic" },
    { key: "pbf_polarized_advance", label: "Polarized Lenses - Advance" },
    { key: "pbf_night_drive_yellow", label: "Night Drive Yellow Colour" },
    { key: "pbf_day_night_basic", label: "Day & Night Lenses Basic" },
    { key: "pbf_day_night_turbo", label: "Day & Night Lenses Turbo" },
  ],
  progressive: [
    ...
    { key: "ppg_blublock_advance", label: "Blu-Block Mild Hi-Index 1.60", description: "20% thinner than basic" },
    { key: "ppg_blublock_premium", label: "Blu-Block Medium Hi-Index 1.67", description: "28% thinner than basic lens" },
    { key: "ppg_blublock_exclusive", label: "Blu-Block Hi-Index 1.74", description: "40% thinner than basic lens" },
    { key: "ppg_poly_ar", label: "Anti-Reflect Polycarbonate" },
    { key: "ppg_poly_blublock", label: "Blu-Block Anti-Reflect Polycarbonate" },
    { key: "ppg_tinted_uv", label: "Tinted UV-Lenses (Select the Color)", requiresTint: true },
    { key: "ppg_polarized_basic", label: "Polarized Lenses - Basic" },
    { key: "ppg_polarized_advance", label: "Polarized Lenses - Advance" },
    { key: "ppg_night_drive_yellow", label: "Night Drive Yellow Colour" },
    { key: "ppg_day_night_basic", label: "Day & Night Lenses Basic" },
    { key: "ppg_day_night_turbo", label: "Day & Night Lenses Turbo" },
  ],
};
