  ...
  try {
    ...
    const product = await prisma.product.create({
      data: {
        ...
        contactLensType: payload.contactLensType || null,
        contactLensCategory: payload.contactLensCategory || null,
        contactLensDisposability: payload.contactLensDisposability || null,
