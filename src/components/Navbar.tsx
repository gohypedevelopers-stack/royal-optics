          ...
          <nav className="ml-auto flex items-center gap-2">
            ...
            {isAdmin ? (
              ...
              <>
                ...
                <UserLogoutButton className="hidden h-10 items-center rounded-lg border border-slate-300 px-3 text-sm font-medium text-slate-700 hover:bg-slate-100 md:inline-flex" />
              </>
            ) : (
              <>
          ...
          <div className="mt-5 rounded border border-slate-200">
            ...
            {!isLoggedIn ? (
              ...
              <>
                ...
                <Link href="/orders" onClick={() => setMenuOpen(false)} className="block border-b border-slate-200 px-3 py-2.5 text-[17px] text-black hover:bg-slate-50">
                  My Orders
                </Link>
                <div className="px-3 py-2.5">
                  <UserLogoutButton
                    onLoggedOut={() => setMenuOpen(false)}
                    className="block w-full rounded-md border border-slate-300 px-3 py-2 text-left text-[17px] text-black hover:bg-slate-50"
                  />
                </div>
              </>
            )}
