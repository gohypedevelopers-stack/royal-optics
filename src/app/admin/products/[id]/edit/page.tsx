      ...
      <CardContent>
        <ProductForm
          ...
          initial={{
            ...
            contactLensType: (item as any).contactLensType || "",
            contactLensCategory: (item as any).contactLensCategory || "",
            contactLensDisposability: (item as any).contactLensDisposability || "",
            gender: item.gender || "",
