...
function buildLensSeedData(): LensSeed[] {
  ...
  const sunglassesNonRx: LensSeed[] = [
    {
      title: "Tinted UV (any color & darkness)",
      description: "~50% UV protection",
      key: "drv_tinted_uv",
      valueType: LensValueType.PRICE,
      category: "Sunglasses / Driving - Non-Prescription",
      group: "Sunglasses / Driving - Non-Prescription",
      sortOrder: 1,
      isActive: true,
      value: 0,
    },
    {
      title: "Night Drive Yellow Colour",
      description: "Yellow anti-glare driving lens",
      key: "drv_night_drive_yellow",
      valueType: LensValueType.PRICE,
      category: "Sunglasses / Driving - Non-Prescription",
      group: "Sunglasses / Driving - Non-Prescription",
      sortOrder: 2,
  ...
  const sunglassesSingleVision: LensSeed[] = [
    {
      title: "Tinted UV (any color & darkness)",
      description: "~50% UV protection",
      key: "drv_sv_tinted_uv",
      valueType: LensValueType.PRICE,
      category: "Sunglasses / Driving - Single Vision",
      group: "Sunglasses / Driving - Single Vision",
      sortOrder: 1,
      isActive: true,
      value: 0,
    },
  ...
  const sunglassesBifocal: LensSeed[] = [
    {
      title: "Tinted UV (any color & darkness)",
      description: "~50% UV protection",
      key: "drv_bf_tinted_uv",
      valueType: LensValueType.PRICE,
      category: "Sunglasses / Driving - Bifocal",
      group: "Sunglasses / Driving - Bifocal",
      sortOrder: 1,
      isActive: true,
      value: 0,
    },
  ...
  const sunglassesProgressive: LensSeed[] = [
    {
      title: "Tinted UV (any color & darkness)",
      description: "~50% UV protection",
      key: "drv_pg_tinted_uv",
      valueType: LensValueType.PRICE,
      category: "Sunglasses / Driving - Progressive",
      group: "Sunglasses / Driving - Progressive",
      sortOrder: 1,
      isActive: true,
      value: 0,
    },
  ...
  return [
    ...
    ...nonRx,
    ...sunglassesNonRx,
    ...sunglassesSingleVision,
    ...sunglassesBifocal,
    ...sunglassesProgressive,
    ...global,
  ];
}
