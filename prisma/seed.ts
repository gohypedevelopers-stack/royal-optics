  ...
  const sunglassesSingleVision: LensSeed[] = [
    {
      ...
      valueType: LensValueType.PRICE,
      category: "Sunglasses Prescription - Single Vision Lenses",
      group: "Sunglasses Prescription - Single Vision Lenses",
      sortOrder: 1,
      isActive: true,
      value: 0,
    },
  ...
  const sunglassesBifocal: LensSeed[] = [
    {
      ...
      valueType: LensValueType.PRICE,
      category: "Sunglasses Prescription - Bifocal Lenses",
      group: "Sunglasses Prescription - Bifocal Lenses",
      sortOrder: 1,
      isActive: true,
      value: 0,
    },
  ...
  const sunglassesProgressive: LensSeed[] = [
    {
      ...
      valueType: LensValueType.PRICE,
      category: "Sunglasses Prescription - Progressive Lenses",
      group: "Sunglasses Prescription - Progressive Lenses",
      sortOrder: 1,
      isActive: true,
      value: 0,
    },
